...
2026/03/01 06:43:01 Found pending approval for event $approval-1
2026/03/01 06:43:01 Reaction received: 👍 on $approval-1
2026/03/01 06:43:01 Sending approval response to channel: allow
2026/03/01 06:43:01 Response sent to channel successfully
--- PASS: TestBridge_HandleReaction_Approve (0.00s)
=== RUN   TestBridge_HandleReaction_Deny
2026/03/01 06:43:01 Found pending approval for event $approval-2
2026/03/01 06:43:01 Reaction received: 👎 on $approval-2
2026/03/01 06:43:01 Sending approval response to channel: deny
2026/03/01 06:43:01 Response sent to channel successfully
--- PASS: TestBridge_HandleReaction_Deny (0.00s)
=== RUN   TestBridge_HandleReaction_Stop
2026/03/01 06:43:01 Found pending approval for event $approval-3
2026/03/01 06:43:01 Reaction received: 🛑 on $approval-3
2026/03/01 06:43:01 Sending approval response to channel: deny
2026/03/01 06:43:01 Response sent to channel successfully
...
2026/03/01 06:43:01 Found pending approval for event $approval-5
2026/03/01 06:43:01 Reaction received: 🎉 on $approval-5
2026/03/01 06:43:01 Ignoring unknown reaction: "🎉"
--- PASS: TestBridge_HandleReaction_UnknownEmoji (0.10s)
=== RUN   TestBridge_RequestApproval_AutoApprove
2026/03/01 06:43:02 Auto-allow: Read (matched rule)
2026/03/01 06:43:02 Auto-deny: Bash (matched rule)
--- PASS: TestBridge_RequestApproval_AutoApprove (0.00s)
=== RUN   TestBridge_RequestApproval_InteractivePrompt
2026/03/01 06:43:02 Waiting for reaction on event $mock-1
2026/03/01 06:43:02 Found pending approval for event $mock-1
2026/03/01 06:43:02 Reaction received: 👍 on $mock-1
2026/03/01 06:43:02 Sending approval response to channel: allow
2026/03/01 06:43:02 Response sent to channel successfully
2026/03/01 06:43:02 Received response from channel: allow
--- PASS: TestBridge_RequestApproval_InteractivePrompt (0.05s)
=== RUN   TestBridge_RequestApproval_InteractiveDeny
2026/03/01 06:43:02 Waiting for reaction on event $mock-1
2026/03/01 06:43:02 Found pending approval for event $mock-1
2026/03/01 06:43:02 Reaction received: 👎 on $mock-1
2026/03/01 06:43:02 Sending approval response to channel: deny
2026/03/01 06:43:02 Response sent to channel successfully
2026/03/01 06:43:02 Received response from channel: deny
...
2026/03/01 06:43:02 No room found for session unknown-session, deferring to CC permissions
...
2026/03/01 06:43:02 Posted startup announcement to ops: dev
...
2026/03/01 06:43:02 Posted drain announcement to ops
...
2026/03/01 06:43:02 Event received: type=m.room.message sender=@alice:example.com room=!test:example.com id=$evt-1770890460000000000 ts=1770890460000
2026/03/01 06:43:02 Draining — ignoring message from @alice:example.com
...
2026/03/01 06:43:02 Event received: type=m.room.message sender=@alice:example.com room=!test:example.com id=$evt-1770890460000000000 ts=1770890460000
2026/03/01 06:43:02 [!test:example.com] @alice:example.com: test
2026/03/01 06:43:02 Invoking claude with args: [-p --output-format stream-json --verbose --dangerously-skip-permissions -- test]
2026/03/01 06:43:02 Claude output line: {"message":{"content":[{"text":"Done!","type":"text"}],"usage":{"input_tokens":100,"output_tokens":50}},"session_id":"sess-drain","type":"assistant"}
2026/03/01 06:43:02 Sent/edited with text content
2026/03/01 06:43:02 Sent initial message: $mock-1
2026/03/01 06:43:02 Claude output line: {"modelUsage":{"default":{"contextWindow":200000}},"result":"Done!","session_id":"sess-drain","type":"result"}
2026/03/01 06:43:02 Context saturation for room !test:example.com: 0% (0k / 200k tokens)
...
2026/03/01 06:43:02 Invoking claude with args: [-p --output-format stream-json --verbose --dangerously-skip-permissions -- [Matrix room: test-room]

Hi there]
2026/03/01 06:43:02 Claude output line: {"message":{"content":[{"text":"Hello from Claude!","type":"text"}],"usage":{"input_tokens":100,"output_tokens":50}},"session_id":"sess-123","type":"assistant"}
2026/03/01 06:43:02 Sent/edited with text content
2026/03/01 06:43:02 Sent initial message: $mock-1
2026/03/01 06:43:02 Claude output line: {"modelUsage":{"default":{"contextWindow":200000}},"result":"Hello from Claude!","session_id":"sess-123","type":"result"}
--- PASS: TestInvokeClaude_SimpleResponse (0.00s)
=== RUN   TestInvokeClaude_MultiSectionEditInPlace
2026/03/01 06:43:02 Invoking claude with args: [-p --output-format stream-json --verbose --dangerously-skip-permissions -- [Matrix room: test-room]

Check something]
2026/03/01 06:43:02 Claude output line: {"message":{"content":[{"text":"Let me check that for you.","type":"text"}],"usage":{"input_tokens":100,"output_tokens":50}},"session_id":"sess-456","type":"assistant"}
2026/03/01 06:43:02 Sent/edited with text content
2026/03/01 06:43:02 Sent initial message: $mock-1
2026/03/01 06:43:02 Claude output line: {"message":{"content":[{"input":{"file_path":"/tmp/test.go"},"name":"Read","type":"tool_use"}],"usage":{"input_tokens":100,"output_tokens":50}},"session_id":"sess-456","type":"assistant"}
2026/03/01 06:43:02 Edited message: $mock-1
2026/03/01 06:43:02 Sent/edited with tool call: Read
2026/03/01 06:43:02 Claude output line: {"message":{"content":[{"text":"Here's what I found.","type":"text"}],"usage":{"input_tokens":100,"output_tokens":50}},"session_id":"sess-456","type":"assistant"}
2026/03/01 06:43:02 Sent/edited with text content (thinking)
2026/03/01 06:43:02 Edited message: $mock-1
2026/03/01 06:43:02 Claude output line: {"modelUsage":{"default":{"contextWindow":200000}},"result":"Here's what I found.","session_id":"sess-456","type":"result"}
2026/03/01 06:43:02 Reverted last section from thinking to plain text
2026/03/01 06:43:02 Edited message: $mock-1
2026/03/01 06:43:02 Final edit: removed working indicator
--- PASS: TestInvokeClaude_MultiSectionEditInPlace (0.00s)
=== RUN   TestInvokeClaude_WorkingIndicatorOnIntermediateEdits
2026/03/01 06:43:02 Invoking claude with args: [-p --output-format stream-json --verbose --dangerously-skip-permissions -- [Matrix room: test-room]

Do work]
2026/03/01 06:43:02 Claude output line: {"message":{"content":[{"text":"Starting work...","type":"text"},{"input":{"command":"ls"},"name":"Bash","type":"tool_use"}],"usage":{"input_tokens":100,"output_tokens":50}},"session_id":"sess-789","t
2026/03/01 06:43:02 Sent/edited with text content
2026/03/01 06:43:02 Sent initial message: $mock-1
2026/03/01 06:43:02 Edited message: $mock-1
2026/03/01 06:43:02 Sent/edited with tool call: Bash
2026/03/01 06:43:02 Claude output line: {"message":{"content":[{"text":"All done.","type":"text"}],"usage":{"input_tokens":100,"output_tokens":50}},"session_id":"sess-789","type":"assistant"}
2026/03/01 06:43:02 Sent/edited with text content (thinking)
2026/03/01 06:43:02 Edited message: $mock-1
2026/03/01 06:43:02 Claude output line: {"modelUsage":{"default":{"contextWindow":200000}},"result":"All done.","session_id":"sess-789","type":"result"}
2026/03/01 06:43:02 Reverted last section from thinking to plain text
2026/03/01 06:43:02 Edited message: $mock-1
2026/03/01 06:43:02 Final edit: removed working indicator
--- PASS: TestInvokeClaude_WorkingIndicatorOnIntermediateEdits (0.00s)
=== RUN   TestInvokeClaude_SessionResume
2026/03/01 06:43:02 Invoking claude with args: [-p --output-format stream-json --verbose --dangerously-skip-permissions --resume existing-sess -- Continue]
2026/03/01 06:43:02 Claude output line: {"message":{"content":[{"text":"Resumed!","type":"text"}],"usage":{"input_tokens":100,"output_tokens":50}},"session_id":"existing-sess","type":"assistant"}
2026/03/01 06:43:02 Sent/edited with text content
2026/03/01 06:43:02 Sent initial message: $mock-1
2026/03/01 06:43:02 Claude output line: {"modelUsage":{"default":{"contextWindow":200000}},"result":"Resumed!","session_id":"existing-sess","type":"result"}
--- PASS: TestInvokeClaude_SessionResume (0.00s)
=== RUN   TestInvokeClaude_FreshSessionNoResume
2026/03/01 06:43:02 Invoking claude with args: [-p --output-format stream-json --verbose --dangerously-skip-permissions -- [Matrix room: test-room]

Hello]
2026/03/01 06:43:02 Claude output line: {"message":{"content":[{"text":"Hello!","type":"text"}],"usage":{"input_tokens":100,"output_tokens":50}},"session_id":"new-sess","type":"assistant"}
2026/03/01 06:43:02 Sent/edited with text content
2026/03/01 06:43:02 Sent initial message: $mock-1
2026/03/01 06:43:02 Claude output line: {"modelUsage":{"default":{"contextWindow":200000}},"result":"Hello!","session_id":"new-sess","type":"result"}
--- PASS: TestInvokeClaude_FreshSessionNoResume (0.00s)
=== RUN   TestInvokeClaude_ContextInfoExtracted
2026/03/01 06:43:02 Invoking claude with args: [-p --output-format stream-json --verbose --dangerously-skip-permissions -- [Matrix room: test-room]

test]
2026/03/01 06:43:02 Claude output line: {"message":{"content":[{"text":"Response","type":"text"}],"usage":{"input_tokens":100,"output_tokens":50}},"session_id":"sess-ctx","type":"assistant"}
2026/03/01 06:43:02 Sent/edited with text content
2026/03/01 06:43:02 Sent initial message: $mock-1
2026/03/01 06:43:02 Claude output line: {"modelUsage":{"default":{"contextWindow":180000}},"result":"Response","session_id":"sess-ctx","type":"result"}
--- PASS: TestInvokeClaude_ContextInfoExtracted (0.00s)
=== RUN   TestInvokeClaude_ThinkingFormatting
2026/03/01 06:43:02 Invoking claude with args: [-p --output-format stream-json --verbose --dangerously-skip-permissions -- [Matrix room: test-room]

test thinking]
2026/03/01 06:43:02 Claude output line: {"message":{"content":[{"text":"Initial response","type":"text"}],"usage":{"input_tokens":100,"output_tokens":50}},"session_id":"sess-think","type":"assistant"}
2026/03/01 06:43:02 Sent/edited with text content
2026/03/01 06:43:02 Sent initial message: $mock-1
2026/03/01 06:43:02 Claude output line: {"message":{"content":[{"input":{"command":"echo hello"},"name":"Bash","type":"tool_use"}],"usage":{"input_tokens":100,"output_tokens":50}},"session_id":"sess-think","type":"assistant"}
2026/03/01 06:43:02 Edited message: $mock-1
2026/03/01 06:43:02 Sent/edited with tool call: Bash
2026/03/01 06:43:02 Claude output line: {"message":{"content":[{"text":"Final answer after tool","type":"text"}],"usage":{"input_tokens":100,"output_tokens":50}},"session_id":"sess-think","type":"assistant"}
2026/03/01 06:43:02 Sent/edited with text content (thinking)
2026/03/01 06:43:02 Edited message: $mock-1
2026/03/01 06:43:02 Claude output line: {"modelUsage":{"default":{"contextWindow":200000}},"result":"Final answer after tool","session_id":"sess-think","type":"result"}
2026/03/01 06:43:02 Reverted last section from thinking to plain text
2026/03/01 06:43:02 Edited message: $mock-1
2026/03/01 06:43:02 Final edit: removed working indicator
...
test]
2026/03/01 06:43:02 Claude output line: {"message":{"content":[{"text":"ok","type":"text"}],"usage":{"input_tokens":100,"output_tokens":50}},"session_id":"sess-env","type":"assistant"}
2026/03/01 06:43:02 Sent/edited with text content
2026/03/01 06:43:02 Sent initial message: $mock-1
2026/03/01 06:43:02 Claude output line: {"modelUsage":{"default":{"contextWindow":200000}},"result":"ok","session_id":"sess-env","type":"result"}
--- PASS: TestInvokeClaude_EnvVarsSet (0.00s)
=== RUN   TestInvokeClaude_HandoffLoadedOnFreshSession
2026/03/01 06:43:02 Loaded handoff for room "test-room" from /tmp/nix-shell.sTNVDy/TestInvokeClaude_HandoffLoadedOnFreshSession127197806/001/handoffs/test-room/2026-02-12_10-00-00.md (24 bytes)
2026/03/01 06:43:02 Invoking claude with args: [-p --output-format stream-json --verbose --dangerously-skip-permissions --append-system-prompt <room-handoff>
...
Hello again]
2026/03/01 06:43:02 Claude output line: {"message":{"content":[{"text":"Got it!","type":"text"}],"usage":{"input_tokens":100,"output_tokens":50}},"session_id":"sess-ho2","type":"assistant"}
2026/03/01 06:43:02 Sent/edited with text content
2026/03/01 06:43:02 Sent initial message: $mock-1
2026/03/01 06:43:02 Claude output line: {"modelUsage":{"default":{"contextWindow":200000}},"result":"Got it!","session_id":"sess-ho2","type":"result"}
--- PASS: TestInvokeClaude_HandoffLoadedOnFreshSession (0.00s)
=== RUN   TestInvokeClaude_ProactiveSplitOnLargeMessage
2026/03/01 06:43:02 Invoking claude with args: [-p --output-format stream-json --verbose --dangerously-skip-permissions -- [Matrix room: test-room]

do big work]
2026/03/01 06:43:02 Claude output line: {"message":{"content":[{"text":"xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
2026/03/01 06:43:02 Sent/edited with text content
2026/03/01 06:43:02 Sent initial message: $mock-1
2026/03/01 06:43:02 Claude output line: {"message":{"content":[{"input":{"command":"echo test"},"name":"Bash","type":"tool_use"}],"usage":{"input_tokens":100,"output_tokens":50}},"session_id":"sess-split","type":"assistant"}
2026/03/01 06:43:02 Edited message: $mock-1
2026/03/01 06:43:02 Sent/edited with tool call: Bash
2026/03/01 06:43:02 Claude output line: {"message":{"content":[{"text":"xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
2026/03/01 06:43:02 Sent/edited with text content (thinking)
2026/03/01 06:43:02 Split: finalized message $mock-1 (30744 bytes), starting fresh
2026/03/01 06:43:02 Sent initial message: $mock-4
2026/03/01 06:43:02 Claude output line: {"modelUsage":{"default":{"contextWindow":200000}},"result":"xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
2026/03/01 06:43:02 Reverted last section from thinking to plain text
...
2026/03/01 06:43:02 Sent/edited with text content
2026/03/01 06:43:02 Sent initial message: $mock-1
2026/03/01 06:43:02 Claude output line: {"message":{"content":[{"text":"CARRIED_OVER_MARKER_xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
2026/03/01 06:43:02 Sent/edited with text content
2026/03/01 06:43:02 Split: finalized message $mock-1 (40960 bytes), starting fresh
2026/03/01 06:43:02 Sent initial message: $mock-3
2026/03/01 06:43:02 Claude output line: {"modelUsage":{"default":{"contextWindow":200000}},"result":"CARRIED_OVER_MARKER_xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
--- PASS: TestInvokeClaude_ProactiveSplitCarriesContent (0.00s)
=== RUN   TestInvokeClaude_FallbackSplitOnEditError
2026/03/01 06:43:02 Invoking claude with args: [-p --output-format stream-json --verbose --dangerously-skip-permissions -- [Matrix room: test-room]

trigger fallback]
2026/03/01 06:43:02 Claude output line: {"message":{"content":[{"text":"short initial","type":"text"}],"usage":{"input_tokens":100,"output_tokens":50}},"session_id":"sess-fallback","type":"assistant"}
2026/03/01 06:43:02 Sent/edited with text content
2026/03/01 06:43:02 Sent initial message: $mock-1
2026/03/01 06:43:02 Claude output line: {"message":{"content":[{"input":{"command":"ls"},"name":"Bash","type":"tool_use"}],"usage":{"input_tokens":100,"output_tokens":50}},"session_id":"sess-fallback","type":"assistant"}
2026/03/01 06:43:02 Edited message: $mock-1
2026/03/01 06:43:02 Sent/edited with tool call: Bash
2026/03/01 06:43:02 Claude output line: {"message":{"content":[{"text":"xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
2026/03/01 06:43:02 Sent/edited with text content (thinking)
2026/03/01 06:43:02 Failed to edit message $mock-1 in !test:example.com: M_TOO_LARGE (HTTP 413): event too large
2026/03/01 06:43:02 Edit failed, splitting to fresh message: M_TOO_LARGE (HTTP 413): event too large
2026/03/01 06:43:02 Split: finalized message $mock-1 (30 bytes), starting fresh
2026/03/01 06:43:02 Sent fallback message: $mock-5
2026/03/01 06:43:02 Claude output line: {"modelUsage":{"default":{"contextWindow":200000}},"result":"done","session_id":"sess-fallback","type":"result"}
2026/03/01 06:43:02 Reverted last section from thinking to plain text
...
2026/03/01 06:43:02 Eviction: removed 1 seenEvents, 0 deniedCache entries older than 24h0m0s
--- PASS: TestBridge_EvictStaleEntries_RemovesOldSeenEvents (0.00s)
=== RUN   TestBridge_EvictStaleEntries_RemovesOldDeniedCache
2026/03/01 06:43:02 Eviction: removed 0 seenEvents, 1 deniedCache entries older than 24h0m0s
...
2026/03/01 06:43:02 Event received: type=m.room.message sender=@agent:example.com room=!test:example.com id=$evt-1770890460000000000 ts=1770890460000
2026/03/01 06:43:02 Ignoring own message
--- PASS: TestBridge_HandleMessage_IgnoresOwnMessages (0.00s)
=== RUN   TestBridge_HandleMessage_IgnoresOldMessages
2026/03/01 06:43:02 Event received: type=m.room.message sender=@alice:example.com room=!test:example.com id=$evt-1770890340000000000 ts=1770890340000
2026/03/01 06:43:02 Ignoring old message (before bridge start)
--- PASS: TestBridge_HandleMessage_IgnoresOldMessages (0.00s)
=== RUN   TestBridge_HandleMessage_IgnoresDuplicateEvents
2026/03/01 06:43:02 Event received: type=m.room.message sender=@alice:example.com room=!test:example.com id=$evt-1770890460000000000 ts=1770890460000
2026/03/01 06:43:02 Ignoring duplicate event $evt-1770890460000000000
...
2026/03/01 06:43:02 Event received: type=m.room.message sender=@alice:example.com room=!ops:example.com id=$evt-1770890460000000000 ts=1770890460000
2026/03/01 06:43:02 Ignoring message in excluded room !ops:example.com
--- PASS: TestBridge_HandleMessage_IgnoresExcludedRooms (0.00s)
=== RUN   TestBridge_HandleMessage_ClearNoSession
2026/03/01 06:43:02 Event received: type=m.room.message sender=@alice:example.com room=!test:example.com id=$evt-1770890460000000000 ts=1770890460000
2026/03/01 06:43:02 [!test:example.com] @alice:example.com: !clear
...
2026/03/01 06:43:02 Event received: type=m.room.message sender=@alice:example.com room=!test:example.com id=$evt-1770890460000000000 ts=1770890460000
2026/03/01 06:43:02 [!test:example.com] @alice:example.com: !new test-room
2026/03/01 06:43:02 Created room "test-room" (!new-room:example.com), invited @alice:example.com
--- PASS: TestBridge_HandleMessage_NewRoom (0.10s)
=== RUN   TestBridge_HandleMessage_NewRoomNoName
2026/03/01 06:43:02 Event received: type=m.room.message sender=@alice:example.com room=!test:example.com id=$evt-1770890460000000000 ts=1770890460000
2026/03/01 06:43:02 [!test:example.com] @alice:example.com: !new
--- PASS: TestBridge_HandleMessage_NewRoomNoName (0.05s)
=== RUN   TestBridge_TypingIndicator_ReadReceiptAndTypingFired
2026/03/01 06:43:02 Event received: type=m.room.message sender=@alice:example.com room=!test:example.com id=$evt-1770890460000000000 ts=1770890460000
2026/03/01 06:43:02 [!test:example.com] @alice:example.com: test
2026/03/01 06:43:02 Invoking claude with args: [-p --output-format stream-json --verbose --dangerously-skip-permissions -- test]
2026/03/01 06:43:02 Claude output line: {"message":{"content":[{"text":"Done!","type":"text"}],"usage":{"input_tokens":100,"output_tokens":50}},"session_id":"sess-typing","type":"assistant"}
2026/03/01 06:43:02 Sent/edited with text content
2026/03/01 06:43:02 Sent initial message: $mock-1
2026/03/01 06:43:02 Claude output line: {"modelUsage":{"default":{"contextWindow":200000}},"result":"Done!","session_id":"sess-typing","type":"result"}
2026/03/01 06:43:02 Context saturation for room !test:example.com: 0% (0k / 200k tokens)
--- PASS: TestBridge_TypingIndicator_ReadReceiptAndTypingFired (0.10s)
=== RUN   TestBridge_TypingIndicator_CancelledOnResponse
2026/03/01 06:43:03 Event received: type=m.room.message sender=@alice:example.com room=!test:example.com id=$evt-1770890460000000000 ts=1770890460000
2026/03/01 06:43:03 [!test:example.com] @alice:example.com: hello
2026/03/01 06:43:03 Invoking claude with args: [-p --output-format stream-json --verbose --dangerously-skip-permissions -- hello]
2026/03/01 06:43:03 Claude output line: {"message":{"content":[{"text":"Quick response","type":"text"}],"usage":{"input_tokens":100,"output_tokens":50}},"session_id":"sess-cancel","type":"assistant"}
2026/03/01 06:43:03 Sent/edited with text content
2026/03/01 06:43:03 Sent initial message: $mock-1
2026/03/01 06:43:03 Claude output line: {"modelUsage":{"default":{"contextWindow":200000}},"result":"Quick response","session_id":"sess-cancel","type":"result"}
2026/03/01 06:43:03 Context saturation for room !test:example.com: 0% (0k / 200k tokens)
--- PASS: TestBridge_TypingIndicator_CancelledOnResponse (0.05s)
=== RUN   TestBridge_TypingIndicator_LastCallIsCancellation
2026/03/01 06:43:03 Event received: type=m.room.message sender=@alice:example.com room=!test:example.com id=$evt-1770890460000000000 ts=1770890460000
2026/03/01 06:43:03 [!test:example.com] @alice:example.com: test
2026/03/01 06:43:03 Invoking claude with args: [-p --output-format stream-json --verbose --dangerously-skip-permissions -- test]
2026/03/01 06:43:03 Claude output line: {"message":{"content":[{"text":"Response","type":"text"}],"usage":{"input_tokens":100,"output_tokens":50}},"session_id":"sess-last","type":"assistant"}
2026/03/01 06:43:03 Sent/edited with text content
2026/03/01 06:43:03 Sent initial message: $mock-1
2026/03/01 06:43:03 Claude output line: {"modelUsage":{"default":{"contextWindow":200000}},"result":"Response","session_id":"sess-last","type":"result"}
2026/03/01 06:43:03 Context saturation for room !test:example.com: 0% (0k / 200k tokens)
--- PASS: TestBridge_TypingIndicator_LastCallIsCancellation (0.05s)
=== RUN   TestBridge_TypingIndicator_NotStartedForExcludedRoom
2026/03/01 06:43:03 Event received: type=m.room.message sender=@alice:example.com room=!ops:example.com id=$evt-1770890460000000000 ts=1770890460000
2026/03/01 06:43:03 Ignoring message in excluded room !ops:example.com
--- PASS: TestBridge_TypingIndicator_NotStartedForExcludedRoom (0.10s)
=== RUN   TestBridge_TypingIndicator_NotStartedWhileDraining
2026/03/01 06:43:03 Event received: type=m.room.message sender=@alice:example.com room=!test:example.com id=$evt-1770890460000000000 ts=1770890460000
2026/03/01 06:43:03 Draining — ignoring message from @alice:example.com
--- PASS: TestBridge_TypingIndicator_NotStartedWhileDraining (0.10s)
=== RUN   TestBridge_StopEmoji_CancelsActiveInvocation
2026/03/01 06:43:03 Event received: type=m.room.message sender=@alice:example.com room=!test:example.com id=$evt-1770890460000000000 ts=1770890460000
2026/03/01 06:43:03 [!test:example.com] @alice:example.com: do something slow
2026/03/01 06:43:03 Invoking claude with args: [-p --output-format stream-json --verbose --dangerously-skip-permissions -- do something slow]
2026/03/01 06:43:03 Stop emoji received in room !test:example.com — cancelling active invocation
2026/03/01 06:43:03 Claude output line: {"message":{"content":[{"text":"This should be interrupted","type":"text"}],"usage":{"input_tokens":100,"output_tokens":50}},"session_id":"sess-stop","type":"assistant"}
2026/03/01 06:43:03 Sent/edited with text content
2026/03/01 06:43:03 Sent initial message: $mock-1
2026/03/01 06:43:03 Claude output line: {"modelUsage":{"default":{"contextWindow":200000}},"result":"This should be interrupted","session_id":"sess-stop","type":"result"}
2026/03/01 06:43:03 Invocation in room !test:example.com was stopped via emoji
2026/03/01 06:43:03 Captured interrupted context for room !test:example.com (1 sections, 26 chars)
--- PASS: TestBridge_StopEmoji_CancelsActiveInvocation (0.50s)
=== RUN   TestBridge_StopEmoji_NoActiveInvocation_FallsThrough
2026/03/01 06:43:03 Found pending approval for event $approval-stop-fallthrough
2026/03/01 06:43:03 Reaction received: 🛑 on $approval-stop-fallthrough
2026/03/01 06:43:03 Sending approval response to channel: deny
2026/03/01 06:43:03 Response sent to channel successfully
--- PASS: TestBridge_StopEmoji_NoActiveInvocation_FallsThrough (0.00s)
=== RUN   TestBridge_HandleMessage_AudioEchoesTranscript
2026/03/01 06:43:03 Event received: type=m.room.message sender=@alice:example.com room=!test:example.com id=$audio-echo-test ts=1770890460000
2026/03/01 06:43:03 Saved audio to /tmp/nix-shell.sTNVDy/TestBridge_HandleMessage_AudioEchoesTranscript1400443971/001/notes/attachments/2026-03-01_06-43-03_voice.ogg (15 bytes)
2026/03/01 06:43:03 Transcribing audio from /tmp/nix-shell.sTNVDy/TestBridge_HandleMessage_AudioEchoesTranscript1400443971/001/notes/attachments/2026-03-01_06-43-03_voice.ogg via http://127.0.0.1:37205
2026/03/01 06:43:03 [!test:example.com] @alice:example.com: [Transcribed from audio]

Hello from voice
2026/03/01 06:43:03 Invoking claude with args: [-p --output-format stream-json --verbose --dangerously-skip-permissions -- [Transcribed from audio]

Hello from voice]
2026/03/01 06:43:03 Claude output line: {"message":{"content":[{"text":"Got it!","type":"text"}],"usage":{"input_tokens":100,"output_tokens":50}},"session_id":"sess-stt","type":"assistant"}
2026/03/01 06:43:03 Sent/edited with text content
2026/03/01 06:43:03 Sent initial message: $mock-2
2026/03/01 06:43:03 Claude output line: {"modelUsage":{"default":{"contextWindow":200000}},"result":"Got it!","session_id":"sess-stt","type":"result"}
2026/03/01 06:43:03 Context saturation for room !test:example.com: 0% (0k / 200k tokens)
--- PASS: TestBridge_HandleMessage_AudioEchoesTranscript (0.00s)
=== RUN   TestGenerateHandoff_WritesFile
2026/03/01 06:43:03 Wrote handoff for room "test-room" to /tmp/nix-shell.sTNVDy/TestGenerateHandoff_WritesFile4051765450/001/handoffs/test-room/2026-03-01_06-43-03.md (32 bytes)
...
2026/03/01 06:43:03 Wrote handoff for room "test-room" to /tmp/nix-shell.sTNVDy/TestGenerateHandoff_ArgsCorrect2535945307/001/handoffs/test-room/2026-03-01_06-43-03.md (15 bytes)
...
2026/03/01 06:43:03 Created context pin $mock-1 in room !test:example.com at 60%
2026/03/01 06:43:03 Cleared context pin in room !test:example.com
--- PASS: TestBridge_ContextPinLifecycle (0.05s)
=== RUN   TestBridge_PinPermissionAlert
2026/03/01 06:43:03 Failed to pin context indicator in !test:example.com (need Moderator power level): M_FORBIDDEN: You don't have permission to send this state event
2026/03/01 06:43:03 Created context pin $mock-1 in room !test:example.com at 60%
--- PASS: TestBridge_PinPermissionAlert (0.05s)
=== RUN   TestBridge_HandleNewRoom
2026/03/01 06:43:03 Created room "my-project" (!new-room:example.com), invited @alice:example.com
--- PASS: TestBridge_HandleNewRoom (0.00s)
=== RUN   TestBridge_HandleInvite
2026/03/01 06:43:03 Invited to room !invited:example.com by @alice:example.com
2026/03/01 06:43:03 Joined room !invited:example.com
--- PASS: TestBridge_HandleInvite (0.00s)
=== RUN   TestBridge_HandleInvite_LowPowerNudge
2026/03/01 06:43:03 Invited to room !invited:example.com by @alice:example.com
2026/03/01 06:43:03 Joined room !invited:example.com
2026/03/01 06:43:03 Insufficient power level (0) in room !invited:example.com, sending nudge
...
2026/03/01 06:43:04 Approval request: session=sess-socket tool=Bash
2026/03/01 06:43:04 Waiting for reaction on event $mock-1
2026/03/01 06:43:04 Found pending approval for event $mock-1
2026/03/01 06:43:04 Reaction received: 👍 on $mock-1
2026/03/01 06:43:04 Sending approval response to channel: allow
2026/03/01 06:43:04 Response sent to channel successfully
2026/03/01 06:43:04 Received response from channel: allow
2026/03/01 06:43:04 Approval response: decision=allow message=
--- PASS: TestBridge_SocketApproval_RoundTrip (0.10s)
=== RUN   TestBridge_SocketApproval_AutoApproveBypass
2026/03/01 06:43:04 Approval request: session=sess-auto tool=Read
2026/03/01 06:43:04 Auto-allow: Read (matched rule)
2026/03/01 06:43:04 Approval response: decision=allow message=
--- PASS: TestBridge_SocketApproval_AutoApproveBypass (0.00s)
=== RUN   TestBridge_SocketConnection_InvalidJSON
2026/03/01 06:43:04 Failed to decode socket request: invalid character 'o' in literal null (expecting 'u')
--- PASS: TestBridge_SocketConnection_InvalidJSON (0.00s)
=== RUN   TestBridge_SocketConnection_UnknownType
2026/03/01 06:43:04 Unknown socket request type: bogus
--- PASS: TestBridge_SocketConnection_UnknownType (0.00s)
=== RUN   TestBridge_SocketResume_RejectedWhileDraining
2026/03/01 06:43:04 Resume request rejected — bridge is draining
...
2026/03/01 06:43:04 Resume breadcrumb was empty, ignoring
--- PASS: TestCheckResumeBreadcrumb_EmptyFile (0.00s)
=== RUN   TestCheckResumeBreadcrumb_RoomIDOnly
2026/03/01 06:43:04 Found resume breadcrumb for room !infra:matrix.example.com — triggering resume
2026/03/01 06:43:04 Invoking claude with args: [-p --output-format stream-json --verbose --dangerously-skip-permissions -- <system-reminder>IMPORTANT: The cranium bridge was restarted. The world may have changed while you were away — tasks you initiated (including ko build pipelines) may have completed. Before continuing, reorient: check whether your in-flight work already landed. Do not assume the state is the same as when you last acted.</system-reminder>]
2026/03/01 06:43:04 Claude output line: {"message":{"content":[{"text":"Resumed successfully!","type":"text"}],"usage":{"input_tokens":100,"output_tokens":50}},"session_id":"sess-resume","type":"assistant"}
2026/03/01 06:43:04 Sent/edited with text content
2026/03/01 06:43:04 Sent initial message: $mock-1
2026/03/01 06:43:04 Claude output line: {"modelUsage":{"default":{"contextWindow":200000}},"result":"Resumed successfully!","session_id":"sess-resume","type":"result"}
2026/03/01 06:43:04 Resume invoke complete for room !infra:matrix.example.com
--- PASS: TestCheckResumeBreadcrumb_RoomIDOnly (0.20s)
=== RUN   TestCheckResumeBreadcrumb_WithCustomMessage
2026/03/01 06:43:04 Found resume breadcrumb for room !infra:matrix.example.com — triggering resume
2026/03/01 06:43:04 Invoking claude with args: [-p --output-format stream-json --verbose --dangerously-skip-permissions -- <system-reminder>Custom upgrade message</system-reminder>]
2026/03/01 06:43:04 Claude output line: {"message":{"content":[{"text":"Back online!","type":"text"}],"usage":{"input_tokens":100,"output_tokens":50}},"session_id":"sess-resume2","type":"assistant"}
2026/03/01 06:43:04 Sent/edited with text content
2026/03/01 06:43:04 Sent initial message: $mock-1
2026/03/01 06:43:04 Claude output line: {"modelUsage":{"default":{"contextWindow":200000}},"result":"Back online!","session_id":"sess-resume2","type":"result"}
2026/03/01 06:43:04 Resume invoke complete for room !infra:matrix.example.com
--- PASS: TestCheckResumeBreadcrumb_WithCustomMessage (0.20s)
=== RUN   TestCheckResumeBreadcrumb_SetsSessionID
2026/03/01 06:43:04 Found resume breadcrumb for room !infra:matrix.example.com — triggering resume
2026/03/01 06:43:04 Invoking claude with args: [-p --output-format stream-json --verbose --dangerously-skip-permissions -- <system-reminder>IMPORTANT: The cranium bridge was restarted. The world may have changed while you were away — tasks you initiated (including ko build pipelines) may have completed. Before continuing, reorient: check whether your in-flight work already landed. Do not assume the state is the same as when you last acted.</system-reminder>]
2026/03/01 06:43:04 Claude output line: {"message":{"content":[{"text":"Ready!","type":"text"}],"usage":{"input_tokens":100,"output_tokens":50}},"session_id":"sess-new-resume","type":"assistant"}
2026/03/01 06:43:04 Sent/edited with text content
2026/03/01 06:43:04 Sent initial message: $mock-1
2026/03/01 06:43:04 Claude output line: {"modelUsage":{"default":{"contextWindow":200000}},"result":"Ready!","session_id":"sess-new-resume","type":"result"}
2026/03/01 06:43:04 Resume invoke complete for room !infra:matrix.example.com
--- PASS: TestCheckResumeBreadcrumb_SetsSessionID (0.20s)
=== RUN   TestCheckResumeBreadcrumb_SendsResponse
2026/03/01 06:43:05 Found resume breadcrumb for room !infra:matrix.example.com — triggering resume
2026/03/01 06:43:05 Invoking claude with args: [-p --output-format stream-json --verbose --dangerously-skip-permissions -- <system-reminder>IMPORTANT: The cranium bridge was restarted. The world may have changed while you were away — tasks you initiated (including ko build pipelines) may have completed. Before continuing, reorient: check whether your in-flight work already landed. Do not assume the state is the same as when you last acted.</system-reminder>]
2026/03/01 06:43:05 Claude output line: {"message":{"content":[{"text":"I'm back and ready!","type":"text"}],"usage":{"input_tokens":100,"output_tokens":50}},"session_id":"sess-resp","type":"assistant"}
2026/03/01 06:43:05 Sent/edited with text content
2026/03/01 06:43:05 Sent initial message: $mock-1
2026/03/01 06:43:05 Claude output line: {"modelUsage":{"default":{"contextWindow":200000}},"result":"I'm back and ready!","session_id":"sess-resp","type":"result"}
2026/03/01 06:43:05 Resume invoke complete for room !infra:matrix.example.com
--- PASS: TestCheckResumeBreadcrumb_SendsResponse (0.20s)
=== RUN   TestCheckResumeBreadcrumb_CleansUpStaleIndicator
2026/03/01 06:43:05 Found resume breadcrumb for room !infra:matrix.example.com — triggering resume
2026/03/01 06:43:05 Cleaning up stale working indicator on event $stale-evt-123
2026/03/01 06:43:05 Invoking claude with args: [-p --output-format stream-json --verbose --dangerously-skip-permissions -- <system-reminder>IMPORTANT: The cranium bridge was restarted. The world may have changed while you were away — tasks you initiated (including ko build pipelines) may have completed. Before continuing, reorient: check whether your in-flight work already landed. Do not assume the state is the same as when you last acted.</system-reminder>]
2026/03/01 06:43:05 Claude output line: {"message":{"content":[{"text":"Resumed!","type":"text"}],"usage":{"input_tokens":100,"output_tokens":50}},"session_id":"sess-cleanup","type":"assistant"}
2026/03/01 06:43:05 Sent/edited with text content
2026/03/01 06:43:05 Sent initial message: $mock-2
2026/03/01 06:43:05 Claude output line: {"modelUsage":{"default":{"contextWindow":200000}},"result":"Resumed!","session_id":"sess-cleanup","type":"result"}
2026/03/01 06:43:05 Resume invoke complete for room !infra:matrix.example.com
--- PASS: TestCheckResumeBreadcrumb_CleansUpStaleIndicator (0.20s)
=== RUN   TestCheckResumeBreadcrumb_SkipsWhenRoomActive
2026/03/01 06:43:05 Found resume breadcrumb for room !infra:matrix.example.com — triggering resume
2026/03/01 06:43:05 Room !infra:matrix.example.com already has active invocation, skipping resume
...
2026/03/01 06:43:05 Posted image test-image.png to room nerve (!nerve:matrix.example.com): event $mock-1
--- PASS: TestBridge_PostImage_Success (0.00s)
=== RUN   TestBridge_PostImage_MissingRoom
2026/03/01 06:43:05 Post image request missing room name
--- PASS: TestBridge_PostImage_MissingRoom (0.00s)
=== RUN   TestBridge_PostImage_MissingPath
2026/03/01 06:43:05 Post image request missing file path
--- PASS: TestBridge_PostImage_MissingPath (0.00s)
=== RUN   TestBridge_PostImage_UnsupportedFormat
2026/03/01 06:43:05 Post image: unsupported format ".pdf"
--- PASS: TestBridge_PostImage_UnsupportedFormat (0.00s)
=== RUN   TestBridge_PostImage_RoomNotFound
2026/03/01 06:43:05 Post image: room "nonexistent" not found
--- PASS: TestBridge_PostImage_RoomNotFound (0.00s)
=== RUN   TestBridge_PostImage_FileNotFound
2026/03/01 06:43:05 Post image: failed to read file /tmp/no-such-file-29387.png: open /tmp/no-such-file-29387.png: no such file or directory
--- PASS: TestBridge_PostImage_FileNotFound (0.00s)
=== RUN   TestBridge_PostAudio_Success
2026/03/01 06:43:05 Posted audio test-audio.mp3 to room nerve (!nerve:matrix.example.com): event $mock-1
--- PASS: TestBridge_PostAudio_Success (0.00s)
=== RUN   TestBridge_PostAudio_MissingRoom
2026/03/01 06:43:05 Post audio request missing room name
--- PASS: TestBridge_PostAudio_MissingRoom (0.00s)
=== RUN   TestBridge_PostAudio_MissingPath
2026/03/01 06:43:05 Post audio request missing file path
--- PASS: TestBridge_PostAudio_MissingPath (0.00s)
=== RUN   TestBridge_PostAudio_UnsupportedFormat
2026/03/01 06:43:05 Post audio: unsupported format ".pdf"
--- PASS: TestBridge_PostAudio_UnsupportedFormat (0.00s)
=== RUN   TestBridge_PostAudio_RoomNotFound
2026/03/01 06:43:05 Post audio: room "nonexistent" not found
--- PASS: TestBridge_PostAudio_RoomNotFound (0.00s)
=== RUN   TestBridge_PostAudio_FileNotFound
2026/03/01 06:43:05 Post audio: failed to read file /tmp/no-such-file-29387.mp3: open /tmp/no-such-file-29387.mp3: no such file or directory
...
2026/03/01 06:43:05 Generated summary for room "test-room" (75 bytes)
--- PASS: TestGenerateSummary_WritesSummaryFile (0.00s)
=== RUN   TestGenerateSummary_ResetsTurns
2026/03/01 06:43:05 Generated summary for room "test-room" (12 bytes)
--- PASS: TestGenerateSummary_ResetsTurns (0.00s)
=== RUN   TestGenerateSummary_ForkSessionArgs
2026/03/01 06:43:05 Generated summary for room "test-room" (7 bytes)
--- PASS: TestGenerateSummary_ForkSessionArgs (0.00s)
=== RUN   TestGenerateSummary_NoSessionSkips
2026/03/01 06:43:05 No session for room !test:example.com, skipping summary generation
--- PASS: TestGenerateSummary_NoSessionSkips (0.00s)
PASS
ok  	github.com/gisikw/cranium	3.866s
